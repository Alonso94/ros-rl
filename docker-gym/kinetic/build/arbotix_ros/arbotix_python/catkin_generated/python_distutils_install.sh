...
echo_and_run cd "/RLProject/kinetic/src/arbotix_ros/arbotix_python"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/RLProject/kinetic/src/arbotix_ros/arbotix_python/setup.py" \
    build --build-base "/RLProject/kinetic/build/arbotix_ros/arbotix_python" \
    install \
    $DESTDIR_ARG \
